    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="container">
          <div class="row">
            <div class="col">
              <button type="button" class="btn btn-outline-primary btn-block option option-a answer">Option 1</button>
            </div>
            <div class="col">
          ...
          <div class="row">
            <div class="col">
              <button type="button" class="btn btn-outline-primary btn-block option option-c">Option 3</button>
            </div>
            <div class="col">

...
<body>
  ...
  <div class="jumbotron jumbotron-fluid animated fadeInDown">
    <div class="container">
      <h1 class="display-3 text-center">TEAM 3</h1>
    </div>
  </div>
  ...
  <div class="container animated fadeInUp delay">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <p class="card-text ">
          Question 1 of Round 1 for Team 3
        </p>
        <div class="container">
          <div class="row">
            <div class="col">
          ...
          <div class="row">
            <div class="col">
              <button type="button" class="btn btn-outline-primary btn-block option option-c answer">Option 3</button>
            </div>
            <div class="col">
        ...
        <hr>
        <a href="T4a.php" class="btn btn-primary btn-block">NEXT</a>
        <!-- link to T2a -->
      </div>
    </div>
  </div>
